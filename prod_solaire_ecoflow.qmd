...
La production hebdomadaire moyenne est de `r round(mean_prod_hebd,3)` kWh.
...
ggplot() +
  ...
  geom_text(data = prod_mens,
            aes(x = mois, y = prod_kWh, label = round(prod_kWh)),
...
Alors que la production mensuelle moyenne (à partir de juin 2025) est de `r round(mean_prod_mens,1)` kWh.
